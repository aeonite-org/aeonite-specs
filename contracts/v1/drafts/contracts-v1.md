...
| `clarifiers`     | yes      | string | profile-owned clarifier validation and interpretation: `none`, `radix_base`, `separator_chars`, or `encoding_name` |
...
clarifiers. `encoding_name` requires exactly one string clarifier.
